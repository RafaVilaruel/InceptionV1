...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/folderstyle.css">
	<meta charset="UTF-8">
		...
		<div class="filesdir" id="list"> 
			...
			<?php
				...
				for($index=0; $index < $indexCount; $index++) {
						...
						if (strpos($dirArray[$index], '.') == false) {
						...
						elseif (strpos($dirArray[$index], 'png') or strpos($dirArray[$index], 'jpg' ) or strpos($dirArray[$index], 'jpeg' )) {
